...
const {
  ...
  REACT_APP_MOVEMENT_ADAPTER_ADDRESS_RINKEBY
} = process.env;
...
export const DAO_FACTORY_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_DAO_FACTORY_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_DAO_FACTORY_CONTRACT_ADDRESS_RINKEBY : '0x534e3e017B3c0ca602360472bC44f8d9eb2aAb8b',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const BANK_FACTORY_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_BANK_FACTORY_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_BANK_FACTORY_CONTRACT_ADDRESS_RINKEBY :'0xE60E2817bBd7BEaf2CEC0232C958321B97A05D00',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const NFT_COLLECTION_FACTORY_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_NFT_COLLECTION_FACTORY_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_NFT_COLLECTION_FACTORY_CONTRACT_ADDRESS_RINKEBY : '0xE60E2817bBd7BEaf2CEC0232C958321B97A05D00',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const ERC20_TOKEN_FACTORY_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_ERC20_TOKEN_FACTORY_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_ERC20_TOKEN_FACTORY_CONTRACT_ADDRESS_RINKEBY : '0xbd24407459ad2E75360ceb16bf52d77Ab162dAaD',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const VOTING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_VOTING_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_VOTING_CONTRACT_ADDRESS_RINKEBY : '0xc9415afc432CC56912f54682cC2Ea80ADdE1a89B',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const CONFIGURATION_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_CONFIGURATION_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_CONFIGURATION_CONTRACT_ADDRESS_RINKEBY : '0x92866ac08edFEAA8C52dEF0c12926FA7E95df8fB',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const RAGEQUIT_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_RAGEQUIT_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_RAGEQUIT_CONTRACT_ADDRESS_RINKEBY : '0xD3C2cE38c905B9207e35D7EcE51c17b22EAb4afe',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const MANAGING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_MANAGING_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_MANAGING_CONTRACT_ADDRESS_RINKEBY :'0x03BE4284E9F3E7d1fd19cB0442713609105db7E7',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const FINANCING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_FINANCING_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_FINANCING_CONTRACT_ADDRESS_RINKEBY : '0xA007fc56f540670F6ba17FD2b3B931FC72A7820a',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const ONBOARDING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_ONBOARDING_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_ONBOARDING_CONTRACT_ADDRESS_RINKEBY : '0x6fA3f2BC09fB13091BF40C6920a9251B72348456',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const GUILDKICK_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_GUILDKICK_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_GUILDKICK_CONTRACT_ADDRESS_RINKEBY : '0xf6F042cB61E409dbFE34A5fbC76Db334B7a93364',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const DAO_REGISTRY_ADAPTER_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_DAO_REGISTRY_ADAPTER_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_DAO_REGISTRY_ADAPTER_CONTRACT_ADDRESS_RINKEBY : '0x35B3babfB8FF455903f6e89cEaa83140e09495F9',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const BANK_ADAPTER_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_BANK_ADAPTER_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_BANK_ADAPTER_CONTRACT_ADDRESS_RINKEBY : '0xed65eD0c561E77597E4D8472be1b4b184c31Fde4',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const NFT_ADAPTER_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_NFT_ADAPTER_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_NFT_ADAPTER_CONTRACT_ADDRESS_RINKEBY : '0xc69DF0C3855A6CaBF0c5983bD504770E5BFA8e84',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const COUPONONBOARDING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_COUPONONBOARDING_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_COUPONONBOARDING_CONTRACT_ADDRESS_RINKEBY :'0xb5935758c16B785d3749F20D65F5B501578dCb1c',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const TRIBUTE_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_TRIBUTE_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_TRIBUTE_CONTRACT_ADDRESS_RINKEBY : '0xD0dCB66d60f6EbF838e22423f58B01D6F7a60187',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const DISTRIBUTE_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_DISTRIBUTE_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_DISTRIBUTE_CONTRACT_ADDRESS_RINKEBY :'0xB54D48D8471839D670C0e24548A7CfEA78bB1879',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const TRIBUTE_NFT_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_TRIBUTE_NFT_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_TRIBUTE_NFT_CONTRACT_ADDRESS_RINKEBY : '0x939Fd23C38496aB54fa4BD0b2ED535DE100f7d8F',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const OFFCHAINVOTING_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_OFFCHAINVOTING_CONTRACT_ADDRESS_RINKEBY 
    ? REACT_APP_OFFCHAINVOTING_CONTRACT_ADDRESS_RINKEBY : '0xDfbe754ec9c2aA26ac2f429CfcEd819910eF5926',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
...
export const MOVEMENT_CONTRACT_ADDRESS = {
  [CHAINS.MAINNET]: '',
  [CHAINS.ROPSTEN]: '',
  [CHAINS.RINKEBY]: REACT_APP_MOVEMENT_ADAPTER_ADDRESS_RINKEBY 
    ? REACT_APP_MOVEMENT_ADAPTER_ADDRESS_RINKEBY : '',
  [CHAINS.GOERLI]: '',
  [CHAINS.KOVAN]: '',
  [CHAINS.GANACHE]: '0xae02a075290D2efD74F0D3fE2DfE64831320855a',
