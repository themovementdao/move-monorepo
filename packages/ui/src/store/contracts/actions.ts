...
type ContractAction =
  ...
  | typeof CONTRACT_MOVEMENT
  | typeof CONTRACT_UNAGII_DEPOSIT
  | typeof CONTRACT_UNAGII_WITHDRAW;
...
export const CONTRACT_MOVEMENT = 'CONTRACT_MOVEMENT';
export const CONTRACT_UNAGII_DEPOSIT = 'CONTRACT_UNAGII_DEPOSIT';
export const CONTRACT_UNAGII_WITHDRAW = 'CONTRACT_UNAGII_WITHDRAW';
...
// Movement
export function initContractMovement(
  web3Instance: Web3,
  contractAddress?: string
) {
  return initContractThunkFactory({
    actionType: CONTRACT_MOVEMENT,
    adapterNameForRedux: DaoAdapterConstants.MOVEMENT,
    adapterOrExtensionName: ContractAdapterNames.movement,
    contractAddress,
    isExtension: false,
    lazyImport: () => import('../../abis/MovementContract.json'),
    web3Instance
  });
}

// UnagiiVaultDeposit
export function initContractUnagiiVaultDeposit(
  web3Instance: Web3,
  contractAddress?: string
) {
  return initContractThunkFactory({
    actionType: CONTRACT_UNAGII_DEPOSIT,
    adapterNameForRedux: DaoAdapterConstants.UNAGII_DEPOSIT,
    adapterOrExtensionName: ContractAdapterNames.unagii_deposit,
    contractAddress,
    isExtension: false,
    lazyImport: () => import('../../abis/UnagiiVaultDepositAdapter.json'),
    web3Instance
  });
}
...
// UnagiiVaultWithdraw
export function initContractUnagiiVaultWithdraw(
  web3Instance: Web3,
  contractAddress?: string
) {
  return initContractThunkFactory({
    actionType: CONTRACT_UNAGII_WITHDRAW,
    adapterNameForRedux: DaoAdapterConstants.UNAGII_WITHDRAW,
    adapterOrExtensionName: ContractAdapterNames.unagii_withdraw,
    contractAddress,
    isExtension: false,
    lazyImport: () => import('../../abis/UnagiiVaultWithdrawAdapter.json'),
    web3Instance
  });
}
