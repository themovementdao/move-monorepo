...
import { CONTRACT_MOVEMENT, CONTRACT_UNAGII_DEPOSIT, CONTRACT_UNAGII_WITHDRAW } from './actions';
...
export default function reducer(
  ...
  switch (type) {
    ...
    case CONTRACT_VOTING_OP_ROLLUP:
      return contractVoting(state, payload);
    case CONTRACT_MOVEMENT:
      return movementContract(state, payload);
    case CONTRACT_UNAGII_DEPOSIT:
      return unagiiDepositContract(state, payload);
    case CONTRACT_UNAGII_WITHDRAW: 
      return unagiiWithdrawContract(state, payload);  
    default:
      return state;
  }
}
...
function movementContract(
  ...
  return {...state, MovementContract: {...payload}};
}

function unagiiDepositContract(
  state: ContractsState,
  payload: any
): ContractsState {
  return {...state, UnagiiDeposit: {...payload}};
}

function unagiiWithdrawContract(
  state: ContractsState,
  payload: any
): ContractsState {
  return {...state, UnagiiWithdraw: {...payload}};
}